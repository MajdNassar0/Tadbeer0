...
const Hero = () => {
  return (
    <section className="bg-[#f8f6f3] py-12 lg:py-20">
      <div className="container mx-auto px-4 sm:px-6 lg:px-20 grid lg:grid-cols-2 items-center gap-10 lg:gap-16">
  ...
  />
        ...
        {/* Text - RIGHT */}
        <div className="space-y-6 text-right order-2 lg:order-2">
  ...
  <span className="text-[#ffc258]">
    لخدماتك المنزلية
          ...
          <div className="flex flex-col sm:flex-row gap-4 sm:gap-6 sm:justify-end">
            <button className="bg-white border border-gray-300 hover:bg-gray-100 transition px-6 py-3 rounded-xl w-full sm:w-auto">
              اكتشف الخدمات
            </button>
