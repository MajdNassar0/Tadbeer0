      ...
      <div className="flex-1 space-y-6 min-w-0">
        ...
        <div className="flex items-center justify-between">
          ...
          <div className="relative">
            ...
            {pendingCount > 0 && (
              <span className="absolute -top-1.5 -left-1.5 min-w-[18px] h-[18px] bg-[#F7A823] text-white text-[10px] font-black rounded-full flex items-center justify-center px-1 shadow">
                +{pendingCount}
              </span>
            )}
          </div>
