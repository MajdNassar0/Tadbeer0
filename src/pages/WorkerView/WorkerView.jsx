                ...
                <div className="flex-1 text-center md:text-right space-y-4">
                  ...
                  <div className="flex flex-wrap items-center justify-center md:justify-start gap-3 pt-2">
                    ...
                    <motion.button
                      ...
                      className="group relative overflow-hidden rounded-2xl border border-[#001F3F]/15 bg-[#001F3F] px-4 py-3 text-white shadow-md transition-all hover:shadow-lg hover:bg-[#002d5a]"
                    >
                      <span className="pointer-events-none absolute inset-0 -translate-x-full skew-x-[-20deg] bg-white/10 transition-transform duration-500 group-hover:translate-x-[150%]" />
                      <span className="relative flex items-center gap-1.5 text-sm font-black whitespace-nowrap">
                        <ExternalLink size={13} className="text-[#F7A823]" />
                        عرض التفاصيل
                        <ChevronLeft size={13} className="text-[#F7A823] transition-transform group-hover:-translate-x-0.5" />
                      </span>
                    </motion.button>
