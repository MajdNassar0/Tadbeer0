...
const Hero = () => {
  return (
    <section className="relative overflow-hidden bg-[#f8f6f3] py-16 lg:py-24" dir="rtl">
      {/* عناصر ديكورية خلفية */}
      ...
      <div className="container mx-auto px-6 lg:px-20 relative z-10">
        <div className="grid lg:grid-cols-12 gap-12 items-center">
          ...
          >
            <div className="space-y-4">
              ...
              <p className="text-gray-600 text-lg md:text-xl leading-relaxed max-w-2xl ml-auto">
                ...
                جودة متناهية، دقة في المواعيد، وموثوقية نعتز بها.
              </p>
            </div>
          ...
          >
            ...
            <div className="absolute -bottom-6 -right-6 w-full h-full border-2 border-yellow-400 rounded-[2.5rem] -z-10 hidden md:block" />
            
            <div className="relative overflow-hidden rounded-[2.5rem] shadow-2xl transform hover:rotate-1 transition-transform duration-500">
              <img
                src={heroImg}
            ...
            {/* بطاقة عائمة صغيرة (Floating Card) لزيادة الاحترافية */}
            <div className="absolute -bottom-4 -left-4 bg-white p-4 rounded-2xl shadow-xl hidden md:flex items-center gap-4 animate-bounce-slow">
